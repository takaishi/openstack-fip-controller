...
type FloatingIPAssociateSpec struct {
	...
	// Foo is an example field of FloatingIPAssociate. Edit FloatingIPAssociate_types.go to remove/update
...
// FloatingIPAssociate is the Schema for the floatingipassociates API
